  ...
  return (
    <div className="inline-flex w-full items-center justify-between border-b border-solid border-elevation-outline-1 px-1">
      <div className="inline-flex h-12 items-center p-3">
        {!toggleState && (
          <AriaButton slot="previous" {...prevButtonProps}>
            <ChevronLeftIcon className="h-6 w-6 text-interactive-icon-idle" />
          </AriaButton>
        )}
      </div>
      ...
      <div className="inline-flex h-12 items-center p-3">
        {!toggleState && (
          <AriaButton slot="next" {...nextButtonProps}>
            <ChevronRightIcon className="h-6 w-6 text-interactive-icon-idle" />
          </AriaButton>
        )}
      </div>
    </div>
