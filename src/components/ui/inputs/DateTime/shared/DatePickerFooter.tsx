...
export const DatePickerFooter = ({ isValid, onTodayPress, onApply }: DatePickerFooterProps) => {
  ...
  return (
    <footer className="flex flex-shrink-0 items-center justify-between gap-2 border-t border-solid border-elevation-outline-1 bg-elevation-surface-1 px-4 py-3 t:bg-elevation-background t:py-1-5">
