...
export const PillButton = ({ children, dismissable, toggle, ...props }: PillButtonProps) => {
  ...
  return (
    <TooltipEllipsis text={children}>
      {(onContentRef) => (
        ...
        >
          <ButtonContent text={children} ref={onContentRef} icon={dismissable ? CloseIcon : undefined} />
        </Component>
      )}
    </TooltipEllipsis>
  );
